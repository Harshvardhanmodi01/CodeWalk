...
export default function LoginPage() {
  ...
  return (
    <div className="bg-background text-on-surface min-h-screen flex flex-col font-body-md selection:bg-primary-container selection:text-on-primary-container relative overflow-hidden">
      ...
      {/* Login Form Panel */}
      <main className="relative z-10 flex-grow flex items-center justify-center px-margin-mobile">
        <div className="w-full max-w-[420px] bg-surface-container border border-outline-variant p-8 relative overflow-hidden rounded-xl shadow-2xl">
          ...
          <div className="space-y-6">
            <div className="text-center space-y-1 select-none">
              <h1 className="font-headline-md text-headline-md text-on-surface font-extrabold">Welcome back</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-end select-none">
                  ...
                  <a className="text-[9px] text-primary-fixed/70 hover:text-primary-fixed font-label-sm uppercase tracking-wider font-bold transition-colors" href="#">
                    Forgot Access?
                  </a>
                </div>
                <div className="relative glow-focus rounded">
            ...
            <div className="pt-2 text-center select-none text-xs">
              <p className="text-on-surface-variant font-label-sm text-xs">
                New entity?{' '}
                <Link className="text-primary-fixed hover:underline font-bold" href="/signup">
