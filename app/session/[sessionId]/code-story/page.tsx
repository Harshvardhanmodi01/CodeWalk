...
export default function CodeStoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d1515] text-[#F1F5F9] flex flex-col">
      {/* Top Header */}
      <header className="flex justify-between items-center px-8 py-4 bg-[#151d1e] border-b border-[#3b494b] select-none">
        ...
        <div className="flex items-center gap-3 text-xs bg-[#0d1515] border border-[#3b494b] px-3 py-1.5 rounded-lg">
          <img 
            src={githubAvatar} 
            alt="GitHub Avatar" 
      ...
      <main className="flex-grow p-8 max-w-6xl mx-auto w-full space-y-6 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#151d1e] border border-[#3b494b] rounded-xl p-6 shadow-xl flex flex-col justify-between h-56">
            <div>
            ...
            <div className="space-y-2 pt-4 border-t border-[#3b494b]">
              <div className="flex flex-wrap gap-1.5">
                {analysis.languages_used.map((lang, idx) => (
                  <span 
                    key={idx} 
                    className="px-2 py-0.5 bg-[#0d1515] border border-[#3b494b] rounded text-[10px] text-[#F1F5F9] font-semibold"
                  >
                    {lang}
                  </span>
                ))}
              </div>
              <div className="w-full bg-[#0d1515] h-1.5 rounded-full overflow-hidden flex">
          ...
          <div className="bg-[#151d1e] border border-[#3b494b] rounded-xl p-6 shadow-xl flex flex-col justify-between h-56">
            ...
            <div className="space-y-2 pt-4 border-t border-[#3b494b]">
              ...
              <div className="w-full bg-[#0d1515] h-2 rounded-full relative overflow-hidden">
                <div 
          ...
          <div className="bg-[#151d1e] border border-[#3b494b] rounded-xl p-6 shadow-xl flex flex-col justify-between h-56">
            ...
            {/* Visual bar graph */}
            <div className="space-y-2 pt-4 border-t border-[#3b494b] flex flex-col justify-end">
        ...
        {/* Large Summary Cards */}
        <div className="bg-[#151d1e] border border-[#3b494b] rounded-xl p-8 shadow-xl space-y-6">
          ...
          <div className="pt-4 border-t border-[#3b494b] text-xs text-[#94A3B8] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Notable Patterns */}
          <div className="bg-[#151d1e] border border-[#3b494b] rounded-xl p-6 shadow-xl space-y-4">
