...
exports.markTokenExhausted = markTokenExhausted;
...
function markTokenExhausted(token) {
    ...
    console.warn(`[TokenPool] Token ${entry.masked} exhausted. Cooldown until ${cooldownUntilISO}. ` +
